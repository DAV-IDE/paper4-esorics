...
def ingest(input_path: Path, output_path: Path, report_path: Path) -> dict:
    ...
    df = _coerce_numeric(df, [
        ...
        "Flow Bytes/s", "Flow Packets/s", "Destination Port", "Protocol",
    ])
...
def parse_args():
    p = argparse.ArgumentParser(description="Ingest real CIC-IDS2017 Friday-Afternoon DDoS (CSV or parquet)")
